...
PXMWindow::PXMWindow(QString hostname, QSize windowSize,
                     bool mute, bool focus, QUuid globalChat, QWidget *parent) :
    QMainWindow(parent), ui(new Ui::PXMWindow), localHostname(hostname),
    globalChatUuid(globalChat), debugWindow(new PXMConsole::Window())
{
    setupGui();
